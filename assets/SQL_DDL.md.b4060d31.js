import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.2c467624.js";const h=JSON.parse('{"title":"DDL相关语句","description":"","frontmatter":{},"headers":[],"relativePath":"SQL/DDL.md","filePath":"SQL/DDL.md"}'),p={name:"SQL/DDL.md"},e=l(`<h1 id="ddl相关语句" tabindex="-1">DDL相关语句 <a class="header-anchor" href="#ddl相关语句" aria-label="Permalink to &quot;DDL相关语句&quot;">​</a></h1><div class="language-SQL vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">SQL</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">-- 查看数据库：</span></span>

import{_ as a,o as n,c as l,O as p}from"./chunks/framework.54bd01e4.js";const d=JSON.parse('{"title":"DDL相关语句","description":"","frontmatter":{},"headers":[],"relativePath":"SQL/DDL.md","filePath":"SQL/DDL.md"}'),e={name:"SQL/DDL.md"};function o(c,s,t,r,i,y){return n(),l("div",null,s[0]||(s[0]=[p(`<h1 id="ddl相关语句" tabindex="-1">DDL相关语句 <a class="header-anchor" href="#ddl相关语句" aria-label="Permalink to &quot;DDL相关语句&quot;">​</a></h1><div class="language-SQL vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">SQL</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">-- 查看数据库：</span></span>
